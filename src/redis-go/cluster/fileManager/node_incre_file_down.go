...
// 获取本地文件当前偏移量
func (nf *NodeFile) getIncrementLocalOffset(fsc *FileSyncClient) int64 {
...
// GetIncrementCurrentLeader 在这里模拟：调用你Dragonboat接口获取最新Leader地址
func (nf *NodeFile) GetIncrementCurrentLeader() (string, int) {
