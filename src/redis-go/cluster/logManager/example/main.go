...
func main() {
	...
	//		break
	//	}
	//	_ = logManager.WriteLocalLog(uint64(i), data)
	//	err = logManager.WriteLocalLog(uint64(i), data)
	...
	//}
	//
	firstIndex, _ := logManager.LocalLog.FirstIndex()
	fmt.Printf("读取日志firstIndex:%d\n", firstIndex)
	lastIndex, _ := logManager.LocalLog.LastIndex()
	...
	err := logManager.RestartBatchLoad(cl)
	if err != nil {
